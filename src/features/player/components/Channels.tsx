...
const Channels = () => {
  ...
  return (
    <div className="pt-8 border-t border-stone-800 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 place-items-center w-full max-w-md">
        {channels.map((channel) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 w-48 justify-center [text-shadow:_0_2px_4px_rgba(0,0,0,0.7)] ${
